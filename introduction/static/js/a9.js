...
// NOTE: For more comprehensive sanitization, consider using a robust library such as DOMPurify.
...
event3 = function(){
    var log_code = escapeHtml(document.getElementById('a9_log').value);
