...
event3 = function(){
    var rawLogCode = document.getElementById('a9_log').value;
    var rawTargetCode = document.getElementById('a9_api').value;
    var log_code = sanitize(rawLogCode);        // Sanitize the log code
    var target_code = sanitize(rawTargetCode);  // Sanitize the target API code
