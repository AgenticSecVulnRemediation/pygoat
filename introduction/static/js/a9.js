...
event3 = function(){
    var rawLogCode = document.getElementById('a9_log').value; // raw input
    var rawTargetCode = document.getElementById('a9_api').value; // raw input
    var log_code = escapeHtml(rawLogCode);      // sanitized input
    var target_code = escapeHtml(rawTargetCode); // sanitized input
