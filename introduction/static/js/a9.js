...
event3 = function(){
    var log_code = sanitizeInput(document.getElementById('a9_log').value);  // Sanitization applied to prevent XSS
    var target_code = sanitizeInput(document.getElementById('a9_api').value);  // Sanitization applied to prevent XSS
