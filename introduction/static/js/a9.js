...
event3 = function(){
    var log_code = DOMPurify.sanitize(document.getElementById('a9_log').value);  // sanitize the input from a9_log
    var target_code = DOMPurify.sanitize(document.getElementById('a9_api').value); // sanitize the input from a9_api
