...
// Sanitizes input by creating a temporary DOM element and using textContent
function sanitize(input) {
    var temp = document.createElement('div');
    temp.textContent = input;
    return temp.innerHTML; // Developer: replace with a more robust sanitization method/library if needed
}
