...
def mitre_lab_17_api(request):
    if request.method == "POST":
        ...
        # Optionally validate the 'ip' input below with a regex (e.g., using the 're' module) to ensure a valid IP address.
        command = ["nmap", ip]  # Replace with additional validation logic if necessary 
