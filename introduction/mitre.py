...
def command_out(command):
    process = subprocess.Popen(command, shell=False, stdout=subprocess.PIPE, stderr=subprocess.PIPE)  # Command must be a list of arguments; ensure proper validation of user input
...
def mitre_lab_17_api(request):
    if request.method == "POST":
        ...
        command = ["nmap", ip]  # TODO: Validate 'ip' is a valid IP address (e.g., using regex or ipaddress module) 
