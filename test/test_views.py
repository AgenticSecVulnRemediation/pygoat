...
def test_ssrf_lab_rejects_paths_resolving_outside_views_dir(mocker):
    ...
    # A path that doesn't contain '..' but can be used to escape on Windows-like joins is blocked by
    # the normalized base-dir check. This should still be rejected if it normalizes outside.
    # We simulate by patching os.path.normpath/join/dirname to force an escaping path.
