...
def test_ssrf_lab_rejects_directory_traversal(monkeypatch):
    """Delta test: ssrf_lab should reject absolute paths and paths containing '..' with an error message."""

    # Arrange: stub django and other deps to import introduction.views
